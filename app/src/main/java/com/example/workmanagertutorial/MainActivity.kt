...
import com.example.workmanagertutorial.ui.theme.WorkManagerTutorialTheme
        ...
        setContent {
            WorkManagerTutorialTheme {
                ...
                Column(
                    ...
                    imageUri?.let { uri ->
                        Image(painter = rememberImagePainter(data = uri), contentDescription = null, modifier = Modifier.fillMaxWidth())
